...
■ Note
- OpenClawはセキュリティ配慮が不十分（開発者も認めている）→ 個人の強みを活かして今のうちにガシガシ使う（中島聡メルマガより）
- ストレッチ＝筋トレと同じ意識。伸ばす筋肉に集中し、最大収縮・最大伸展・呼吸を忘れない
- 筋トレをガチでやり、成果を出す→事業化へつなげる
- 自転車HIIT導入: 攻め日167bpm（5分）×3日 / 休み日120bpm×2日
