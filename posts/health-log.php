...
- パッションフルーツ 1個
- レモン汁
→ 1,091kcal / P:49g / F:30g / C:153g / Fiber:16g
...
■ 栄養学メモ — Week 1：タンパク質の基礎
今日のタンパク源（卵・納豆・サーモン）は全てアミノ酸スコア最高クラス。

アミノ酸スコア（PDCAAS）：タンパク質の"質"を0-100で測る指標。
- 卵：100（基準値）
- 大豆（納豆）：100（植物性で唯一トップクラス）
- 魚（サーモン）：99

9種の必須アミノ酸は体内で合成できないため、食事で補う必要がある。
中でも筋肉合成のスイッチを入れるのはBCAAの「ロイシン」。1食あたり2-3g が合成を最大化する閾値。
卵2個＋納豆1パックで約2.5g → 今日の朝食はその条件をクリアしている。
  </pre>
...
■ 今週の栄養テーマ（Week 1：タンパク質）
・アミノ酸スコア（PDCAAS）— タンパク質の"質"を測る指標（0-100）
・筋肉合成のスイッチ — ロイシン（BCAA）が1食2-3gで合成を最大化
・摂取タイミング — 運動後30分以内＋就寝前が合成ピーク
  </pre>
